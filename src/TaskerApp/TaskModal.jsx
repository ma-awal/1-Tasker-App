...
function TaskModal({ onSave, onClose, updateTask }) {
  ...
  return (
    <div className="fixed inset-0 bg-gray-800  bg-opacity-95 flex items-center justify-center  ">
      <div className="bg-slate-600 w-1/4 rounded-lg shadow-lg p-6">
        ...
        <form className="space-y-4">
          ...
          <div>
            <label
              htmlFor="taskTags"
              className="block text-sm font-medium text-white mb-2   py-1 px-2"
            >
              Tags
            </label>
            <input
          ...
          <div>
            <label
              ...
              className="block text-sm font-medium text-white mb-2 outline-none"
            >
              Priority
            </label>
            <select
          ...
          <div className="flex justify-end space-x-4">
            <button
              type="button"
              onClick={onClose}
              className="px-4 py-2 bg-red-500  text-white  hover:bg-red-900"
            >
              Cancel
            </button>
            <button
              onClick={() => onSave(task, isAdd)}
              className="px-4 py-2 bg-orange-600 text-white   hover:bg-blue-600"
            >
              Save
            </button>
          </div>
